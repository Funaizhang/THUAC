...
class Linear(Layer):
    ...
    def save_weights(self, model_name, loss_name, epoch):
        wb_save(self.W, model_name, loss_name, epoch, self.name, W_or_b='W')
        wb_save(self.b, model_name, loss_name, epoch, self.name, W_or_b='b')
