...
embedding_size = [100]
#embedding_size = [100, 200, 300]  # Dimension of the embedding vector.


# Step 1: Load the data using iterator
...
#                    print(log_str)
    ...
    output_filename = 'embeddings_' + str(embedding_size) + '.txt'
...
def word2vec_basic():
  """Building, training and visualizing a word2vec model."""
